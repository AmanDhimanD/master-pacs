...
const TotalStudyData = () => {
    ...
    const fetchData = async () => {
        ...
        const apiUrl = `http://localhost:8000/api/v2/getstudydata?studyId=4009`;
        //http://localhost:8000/api/v2/getstudydata?studyId=4009
    ...
    const handleView = () => {
        const newWindow = window.open(`http://127.0.0.1:8080/index.html?studyId=` + studyId, '_blank', 'width=1500,height=760');
